...
import { assuntos, integrantes } from './info.js';
        ...
        return `
            <div class="group h-100 w-64 perspective-[1000px]">
                <div class="relative h-full w-full rounded-xl shadow-xl transition-all duration-700 transform-3d group-hover:transform-[rotateY(180deg)]">
                    ...
                    <div class="absolute inset-0 h-full w-full backface-hidden hover:z-0">
                        <img class="h-full w-full rounded-xl object-cover shadow-lg" src="${membro.foto}" alt="${membro.nome}" />
                    </div>

                    <div class="absolute inset-0 h-full w-full rounded-xl bg-white border border-gray-200 px-6 text-center text-gray-900 backface-hidden transform-[rotateY(180deg)] flex flex-col items-center justify-center z-10">
